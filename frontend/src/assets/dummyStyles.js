...
export const loginStyles = {
  ...
  headerSubtitle: "text-xs font-semibold text-slate-300 mt-1.5",
  ...
  label: "block text-xs font-bold uppercase tracking-wider text-slate-300 mb-1.5",
  inputContainer: "relative flex items-center",
  inputIcon: "absolute left-4 text-slate-400 pointer-events-none w-4 h-4",
  input: "w-full pl-11 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 text-white font-semibold text-xs placeholder-slate-400 transition-all",
  paswordinput: "w-full pl-11 pr-11 py-3 bg-slate-800 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 text-white font-semibold text-xs placeholder-slate-400 transition-all",
  passwordToggle: "absolute right-4 text-slate-400 hover:text-white focus:outline-none transition-colors cursor-pointer",
  submitButton: "w-full py-3.5 bg-teal-500 hover:bg-teal-400 text-slate-950 font-extrabold text-sm rounded-xl shadow-lg hover:shadow-teal-500/20 active:scale-[0.99] transition-all flex items-center justify-center gap-2 cursor-pointer disabled:opacity-50",
  checkboxContainer: "flex items-center justify-between mb-6",
  checkboxLabel: "flex items-center gap-2.5 text-xs font-semibold text-slate-300 cursor-pointer select-none",
  ...
  footerText: "text-center text-xs font-semibold text-slate-400 mt-8",
  footerLink: "text-teal-400 hover:text-teal-300 font-bold transition-colors ml-1"
};

export const navbarStyles = {
  header: "sticky top-0 z-40 bg-white/95 dark:bg-slate-900/95 backdrop-blur-md border-b border-slate-200/80 dark:border-slate-800 transition-colors",
  container: "flex items-center justify-between px-4 py-3 md:px-8 max-w-7xl mx-auto",
  
  logoContainer: "flex items-center gap-3 cursor-pointer group",
  logoImage: "w-9 h-9 md:w-10 md:h-10 rounded-xl overflow-hidden shadow-sm shrink-0 bg-teal-500/10 p-1 border border-teal-500/20 flex items-center justify-center",
  logo: "w-full h-full object-contain filter drop-shadow-sm",
  logoText: "text-lg md:text-xl font-black text-slate-900 dark:text-white tracking-tight",
  ...
  userEmail: "text-[10px] text-slate-500 dark:text-slate-300 truncate max-w-[120px]",
  ...
  dropdownEmail: "text-[10px] text-slate-500 dark:text-slate-300",
...
export const signupStyles = {
  ...
  headerTitle: "text-2xl font-extrabold text-white tracking-tight",
  headerSubtitle: "text-xs font-semibold text-slate-300 mt-1",
  ...
  inputIcon: "absolute left-4 text-slate-400 pointer-events-none w-4 h-4",
  input: "w-full pl-11 pr-4 py-3 bg-slate-800 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 text-white font-semibold text-xs placeholder-slate-400 transition-all",
  passwordInput: "w-full pl-11 pr-11 py-3 bg-slate-800 border border-slate-700 rounded-xl focus:outline-none focus:ring-2 focus:ring-teal-500 text-white font-semibold text-xs placeholder-slate-400 transition-all",
  passwordToggle: "absolute right-4 text-slate-400 hover:text-white cursor-pointer",
  ...
  checkboxLabel: "ml-2.5 block text-xs font-semibold text-slate-300 cursor-pointer",
  
  button: "w-full bg-teal-500 hover:bg-teal-400 text-slate-950 font-extrabold text-sm py-3.5 rounded-xl shadow-lg hover:shadow-teal-500/20 transition-all flex items-center justify-center cursor-pointer",
  buttonDisabled: "opacity-50 cursor-not-allowed",
  
  signInContainer: "mt-6 text-center",
  signInText: "text-xs font-semibold text-slate-400",
...
export const borrowLendStyles = {
  container: "space-y-6 max-w-7xl mx-auto p-4 md:p-6 lg:p-8 pb-24",
